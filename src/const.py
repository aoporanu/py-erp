...
NEW_USER_GROUP = os.path.normpath('/home/adyopo/py-erp/data/user_group_new.png')
SETTINGS_ICO = os.path.normpath('/home/adyopo/py-erp/data/settings_ico2.png')
NEW_DOC = os.path.normpath('/home/adyopo/py-erp/data/new_doc.png')
NEXT_ICO = os.path.normpath('/home/adyopo/py-erp/data/next.png')
SEARCH_ICO = os.path.normpath('/home/adyopo/py-erp/data/search.png')
VIEW_REFRESH_ICO = os.path.normpath('/home/adyopo/py-erp/data/view_refresh.png')
EDIT_ADD = os.path.normpath('/home/adyopo/py-erp/data/edit_add.png')
...
ADD_TO_CART = os.path.normpath('/home/adyopo/py-erp/data/cart_add.png')
tmp = PIL.Image.open(ADD_TO_CART).resize((25, 25), PIL.Image.ANTIALIAS)
REMOVE_FROM_CART = os.path.normpath('/home/adyopo/py-erp/data/cart_remove.png')
