from tkinter import Frame, FLAT, VERTICAL, YES, Y, StringVar, N, E, S, W, END, X
from tkinter.ttk import Style, Treeview, Label, Scrollbar
...
class DBTable(object):
    """This Class is a Database container
          ...
          Table Properties :-
            ...
            4. Item are stored in the table using dict only with same fieldnames keys eg DB['Product1']={'Product
            Name':'Motor Pump','Log Date':'January 12,2015'}
