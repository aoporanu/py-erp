...
from src.GraphList import *
from src.ChoiceButton import ChoiceButton
...
class Graph(Frame):
    ...
    def __init__(self, master, currency, db, **kwrgs):
        ...
        self.toolbar = NavigationToolbar2Tk(self.canvas, self.app71)
        self.toolbar.update()
    ...
    def _quit(self):
        ...
        self.a.text(0.1, maxi - 0.1, month, horizontalalignment='left', verticalalignment='top',
